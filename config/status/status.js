...
const ERROR_INCORRECT_LOGIN = {status: false, status_code: 404, message:"Seu Login não foi autorizado!!"}
...
const SUCCES_LOGIN_COMPLETED = {status: true, status_code: 200, message:"Login realizado com sucesso!!"}
