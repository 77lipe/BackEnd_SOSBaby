...
export const updateDoctor = async function (dataDoctor, contentType) {
    try {
        ...
        if (String(contentType).toLocaleLowerCase() === 'application/json') {
            if (
                dataDoctor.id == null        || dataDoctor.id == undefined        || dataDoctor.id == ""        || isNaN(dataDoctor.id)            ||
                dataDoctor.nome == null      || dataDoctor.nome == undefined      || dataDoctor.nome == ""      || dataDoctor.nome.length > 100    ||
                ...
                dataDoctor.foto == null      || dataDoctor.foto == undefined      || dataDoctor.cpf == ""       || dataDoctor.cpf.length > 15      ||
