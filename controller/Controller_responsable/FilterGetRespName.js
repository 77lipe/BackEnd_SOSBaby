...
import { NameFilterResp } from '../../model/ResponsableDAO/FilterResp.js'

export const FilterNameRespController = async function(dataName, contentType){
    try {
        ...
        if(String(contentType).toLocaleLowerCase() == 'application/json'){
            if(
                ...
                let resultName = await NameFilterResp(dataName.name)
                if(resultName){
