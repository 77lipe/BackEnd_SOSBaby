 ...
 *       validações dos dados recebidos para GET DICAS BY SUB relacionamento 
 *                                           DICAS e SUBCATEGORIAS
 ********************************************************/

import * as message from '../../../config/status/status.js'
import { getALLInnerSQLTip } from '../../../model/TipDAO/Tip_SubCategoryDAO/getInnerSQLTip.js'

export const selectTipBySub = async function(idSub){
    try {
        ...
        if(idSub == "" || isNaN(idSub) || idSub == undefined || idSub == null){
            ...
            let dadosJson = {}
            let resultTipSub = await getALLInnerSQLTip(idSub)
