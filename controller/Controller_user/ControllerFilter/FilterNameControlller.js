...
import { NameFilter } from '../../../model/UserDAO/filterDAO/NameFilter.js'

export const FilterNameController = async function(dataName, contentType){
    try {
        ...
        if(String(contentType).toLocaleLowerCase() == 'application/json'){
            if(
                ...
                let resultName = await NameFilter(dataName.name)
                if(resultName){
